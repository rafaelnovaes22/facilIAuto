...
class Conversation(Base):
    ...
    context_data = relationship("ConversationContext", back_populates="conversation", cascade="all, delete-orphan")
...
Index('idx_msg_conv_type', ConversationMessage.conversation_id, ConversationMessage.message_type)
Index('idx_ctx_conv_type', ConversationContext.conversation_id, ConversationContext.context_type)
