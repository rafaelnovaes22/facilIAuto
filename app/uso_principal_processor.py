    ...
    CRITERIOS_USO = {
        ...
        "viagem": {
            "conforto_viagens_longas": {
                "peso": 20,
                "bancos_essenciais": ["regulagem_altura", "apoio_lombar", "couro_tecido_premium"],
                "climatizacao": ["ar_condicionado", "climatizador_automatico", "saidas_traseiras"],
            ...
            "desempenho_seguranca_estrada": {
                ...
                "estabilidade": ["controle_estabilidade", "controle_tracao", "abs_avancado"],
                "freios": ["freios_disco", "assistencia_frenagem", "distribuicao_eletronica"],
            ...
            "espaco_capacidade_carga": {
                "peso": 15,
                "categorias_ideais": ["SUV", "Sedan Médio", "SUV Médio", "Wagon", "Minivan"],
                "porta_malas_litros": {"minimo": 400, "ideal": 500},
                "passageiros": {"minimo": 5, "ideal": 7},
                "versatilidade": ["bancos_rebatraveis", "porta_malas_amplo", "compartimentos"],
            ...
            "economia_combustivel_estrada": {
                ...
                "tecnologias_economia": ["injecão_eletronica", "start_stop", "eco_mode"],
            ...
            "tecnologia_entretenimento": {
                ...
                "conectividade": ["android_auto", "apple_carplay", "wifi", "usb_multiplas"],
            ...
            "confiabilidade_viagem": {
                "peso": 8,
                "marcas_confiaveis": ["Toyota", "Honda", "Volkswagen", "Hyundai", "Chevrolet"],
                "km_maximo": 100000,
                "historico_revisoes": ["concessionaria", "revisado", "garantia"],
                "reputacao_estrada": ["baixa_quebra", "pecas_disponiveis", "rede_autorizada"]
            },
            "facilidade_dirigibilidade": {
                "peso": 7,
                "transmissao": ["automatico", "cvt", "manual_suave"],
                "direcao": ["assistida_eletrica", "hidraulica_leve", "responsiva"],
                "assistencias": ["piloto_automatico", "controle_velocidade", "alerta_faixa"],
        ...
        "trabalho": {
            "economia_combustivel": {"peso": 20, "consumo_minimo": 10, "cilindrada_ideal": [1.0, 1.4, 1.6]},
            "confiabilidade": {"peso": 20, "marcas_confiaveis": ["Toyota", "Honda", "Chevrolet", "Volkswagen"], "km_maximo": 80000},
            "baixo_custo_manutencao": {"peso": 15, "marcas_economicas": ["Chevrolet", "Fiat", "Volkswagen"], "pecas_acessiveis": True},
            "espaco_capacidade": {"peso": 15, "categorias_versateis": ["Hatch", "Sedan", "SUV Compacto", "Pickup", "Van"]},
            "conforto_tecnologia": {"peso": 10, "opcionais_essenciais": ["ar_condicionado", "direcao_assistida", "conectividade"]},
            "aceitacao_plataformas": {"peso": 10, "ano_minimo": 2012, "portas_minimas": 4, "ar_obrigatorio": True},
            "garantia_procedencia": {"peso": 5, "concessionaria_boost": True, "revisado": True},
            "financiamento_facilidade": {"peso": 3, "aceita_cnpj": True, "aceita_mei": True},
            "sustentabilidade": {"peso": 2, "tipos_motor": ["flex", "híbrido", "elétrico"]}
        },
        ...
        "familia": {
            "seguranca_avancada_familia": {
                ...
                "estrutura_seguranca": ["zona_deformacao", "celula_rigida", "absorvedor_impacto"],
                "sistemas_ativos": ["abs", "controle_estabilidade", "assistencia_frenagem"],
                "subsegmento_boost": {"criancas_pequenas": 1.4, "familia_grande": 1.2}
            },
            "espaco_passageiros_conforto": {
                "peso": 20,
                "categorias_ideais": ["SUV", "Minivan", "SUV Médio", "Sedan Médio", "Wagon"],
                "pessoas_capacidade": {"minimo": 5, "ideal": 7},
                "espaco_interno": ["pernas_traseiras", "altura_teto", "largura_bancos"],
                "conforto_ocupantes": ["ar_condicionado", "saidas_traseiras", "apoio_braco"],
            ...
            "praticidade_uso_familiar": {
                ...
                "configuracao_flexivel": ["bancos_rebatraveis", "divisoria_removivel", "compartimentos"],
                "porta_malas_familia": {"minimo_litros": 350, "ideal_litros": 500},
                "conveniencias": ["vidros_eletricos", "travas_eletricas", "espelhos_eletricos"],
                "subsegmento_boost": {"atividades_esportivas": 1.3}
            },
            "custo_beneficio_familia": {
                "peso": 15,
                "preco_justo": {"faixa_ideal": [30000, 80000], "depreciacao_baixa": True},
                "custo_manutencao": ["pecas_acessiveis", "rede_autorizada", "revisoes_programadas"],
                "seguro_acessivel": ["categoria_baixa", "perfil_familia", "dispositivos_seguranca"],
                "economia_operacional": ["combustivel_eficiente", "durabilidade_alta"]
            },
            "confiabilidade_transporte": {
                "peso": 10,
                "marcas_familia": ["Toyota", "Honda", "Volkswagen", "Hyundai", "Chevrolet", "Ford"],
                "historico_confiavel": ["baixo_recall", "satisfacao_proprietarios", "durabilidade"],
                "garantia_suporte": ["garantia_estendida", "rede_concessionarias", "suporte_tecnico"],
                "km_adequada": {"maximo": 80000, "ideal": 50000}
            },
            "tecnologia_seguranca_infantil": {
                "peso": 8,
                "isofix_completo": ["pontos_ancoragem", "top_tether", "guias_instalacao"],
                "travas_seguranca": ["portas_traseiras", "vidros_traseiros", "cinto_bloqueio"],
            ...
            "eficiencia_combustivel_familia": {
                ...
                "tecnologias_economia": ["injecao_eletronica", "start_stop", "eco_mode"],
                "motores_eficientes": [1.0, 1.4, 1.6, 1.8]  # cilindradas ideais
            },
            "versatilidade_configuracao": {
                "peso": 5,
                "flexibilidade_interior": ["bancos_60_40", "encosto_rebativel", "altura_ajustavel"],
                "espacos_uteis": ["porta_objetos", "console_central", "porta_copos"],
                "facilidades_familia": ["ganchos_sacolas", "iluminacao_interna", "tomadas_12v"]
            }
        }
    }
