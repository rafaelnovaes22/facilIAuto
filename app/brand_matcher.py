...
class AdvancedBrandMatcher:
    ...
    def find_best_model_match(self, user_input: str, brand: str = "") -> BrandMatch:
        ...
        if not normalized_input or user_input.lower() in ['aberto_opcoes', 'sem_preferencia']:
    ...
    def validate_and_normalize_preferences(self, marca: str, modelo: str) -> Dict[str, any]:
        ...
        return {
            ...
            "needs_confirmation": (
                brand_match.confidence < 0.8 or 
                model_match.confidence < 0.8 or 
                len(brand_match.suggestions) > 0
            )
        }
