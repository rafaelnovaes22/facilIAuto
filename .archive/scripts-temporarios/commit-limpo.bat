@echo off
REM Script para commit limpo - apenas o essencial
...
git add "Agent Orchestrator/" "AI Engineer/" "Business Analyst/" "Content Creator/" "Data Analyst/" "Financial Advisor/" "Marketing Strategist/" "Operations Manager/" "Product Manager/" "Sales Coach/" "System Archictecture/" "Tech Lead/" "UX Especialist/"
