...
class TestUsoMrincipalE2E:
    ...
    async def test_fluxo_completo_com_uso_principal(self, page: Page, live_server):
        ...
        assert any(termo in results_content.lower() for termo in ['urbano', 'familiar', 'família']), \
    ...
    async def test_chatbot_agente_uso_principal(self, page: Page, live_server):
        ...
        assert any(keyword in resposta.lower() for keyword in uso_keywords), \
    ...
    async def test_scoring_avancado_uso_principal(self, page: Page, live_server):
        ...
        await page.goto(f"{live_server}/api/buscar", method='POST', data={
        ...
        assert any(keyword in sugestoes for keyword in urbano_keywords), \
