...
class TestLangGraphAgentsE2E:
    ...
    async def test_agente_financeiro_comprehensive(self, client, comprehensive_car_data):
        ...
        for i, scenario in enumerate(financial_scenarios):
            ...
            financial_quality = {
                ...
                "mentions_documentation": any(term in resposta for term in ["documento", "cpf", "renda", "aprovação"])
            }
    ...
    async def test_agente_comparacao_comprehensive(self, client, comprehensive_car_data):
        ...
        for i, scenario in enumerate(comparison_scenarios):
            ...
            comparison_quality = {
                ...
                "has_comparison_words": any(word in resposta for word in ["melhor", "pior", "superior", "inferior", "vantagem", "desvantagem"]),
    ...
    async def test_cross_agent_consistency(self, client, comprehensive_car_data):
        ...
        overall_consistency = 1.0 - (len(inconsistencies) / sum(len(test.get("expected_consistency", [])) for test in consistency_tests))
