...
class TestUsoMatcher:
    ...
    def test_calcular_score_uso_urbano(self):
        ...
        carro = {
            ...
            "opcionais": ["central_multimidia", "bluetooth", "usb", "abs", "airbag_duplo", "ar_condicionado"],
            "combustivel": "flex",
            "seguranca": 4,
            "ano": 2020,
            "preco": 45000
    ...
    def test_calcular_score_uso_viagem(self):
        ...
        carro = {
            ...
            "pessoas_transportar": 5,
            "opcionais": ["ar_condicionado", "climatizador_automatico", "bancos_couro", "gps_integrado", 
                         "android_auto", "controle_estabilidade", "abs", "airbag_multiplos", "direcao_assistida"],
            "combustivel": "flex",
            "seguranca": 5,
            "revisado": True,
            "km": 45000,
    ...
    def test_calcular_score_uso_trabalho(self):
        ...
        assert any("economia" in ponto.lower() or "profissional" in ponto.lower() or "plataformas" in ponto.lower() for ponto in pontos_fortes)
    ...
    def test_calcular_score_uso_familia(self):
        ...
        carro = {
            ...
            "pessoas_transportar": 5,
            "preco": 65000,
            "opcionais": ["ar_condicionado", "airbag_multiplos", "abs", "controle_estabilidade", 
                         "vidros_eletricos", "travas_eletricas", "isofix", "camera_re", "bancos_rebatraveis"],
            "combustivel": "flex",
            "seguranca": 5,
            "revisado": True,
            "km": 35000,
    ...
    def test_gerar_sugestoes_uso(self):
        ...
        assert any(any(word in sugestao.lower() for word in ["cidade", "compacto", "economia", "estacion"]) for sugestao in sugestoes)
